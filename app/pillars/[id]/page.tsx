...
import { updatePillar } from '@/lib/actions/pillars';
...
export default async function PillarDetailPage({ params, searchParams }: PillarDetailPageProps) {
  ...
  return (
    <div className="flex flex-col gap-8 animate-in fade-in duration-300">
      ...
      <section className="bg-white border border-border-warm rounded-3xl p-6 md:p-8 relative overflow-hidden warm-shadow">
        ...
        {isEditing ? (
          ...
          <form action={handleUpdateDetails} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                required
                className="h-10 px-3.5 text-sm bg-surface-container-low border border-border-warm text-text-primary rounded-xl focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all"
              />
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="p-3.5 text-sm bg-surface-container-low border border-border-warm text-text-primary rounded-xl focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all resize-none"
              />
            </div>
            ...
            <div className="flex gap-2 justify-end mt-2">
              <Link
                ...
                className="h-10 px-4 bg-white border border-border-warm hover:bg-surface-container-low text-text-secondary hover:text-text-primary text-xs font-semibold rounded-xl flex items-center gap-2 transition-colors"
              >
                <X className="w-4 h-4" />
                Cancel
              </Link>
              <button
                type="submit"
                className="h-10 px-4 bg-primary hover:opacity-95 text-white text-xs font-semibold rounded-xl flex items-center gap-2 shadow-md transition-colors"
              >
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border-warm pb-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-2">
                    <h1 className="text-xl md:text-2xl font-serif font-bold tracking-tight text-text-primary line-clamp-1">
                      {pillar.title}
                    </h1>
              ...
              <div className="flex items-center gap-2">
                ...
                <Link
                  ...
                  className="h-9 w-9 bg-white border border-border-warm text-text-secondary hover:text-text-primary hover:border-primary/45 rounded-lg flex items-center justify-center transition-colors shadow-sm"
                  title="Edit details"
                >
                  <Edit3 className="w-4 h-4" />
                </Link>

                <DeletePillarButton pillarId={id} />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-text-primary leading-relaxed max-w-4xl whitespace-pre-wrap">
      ...
      <section className="flex flex-col gap-6 w-full">
        ...
        {activeTab === 'products' ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in duration-200">
            ...
            <div className="bg-white border border-border-warm rounded-3xl p-6 flex flex-col justify-between gap-6 group hover:border-primary/30 transition-all warm-shadow">
              <div className="flex flex-col gap-4">
                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary">
                  <Columns className="w-5 h-5" />
                </div>
                <div className="flex flex-col gap-1">
                  <h3 className="text-sm font-serif font-bold text-text-primary">Connected Products</h3>
                  <p className="text-[10px] text-sage font-extrabold uppercase tracking-wider flex items-center gap-1">
              ...
              <Link
                ...
                className="h-9 w-full bg-white border border-border-warm hover:bg-surface-container-low text-text-primary text-[10px] font-bold rounded-lg flex items-center justify-center gap-1.5 transition-colors"
              >
                Open Products Graph
              </Link>
            </div>
            ...
            <div className="bg-white border border-border-warm rounded-3xl p-6 flex flex-col justify-between gap-6 group hover:border-primary/30 transition-all warm-shadow">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <h3 className="text-sm font-serif font-bold text-text-primary">Research & Bookmarks</h3>
                  <p className="text-[10px] text-sage font-extrabold uppercase tracking-wider flex items-center gap-1">
                    <Check className="w-3.5 h-3.5 text-sage" />
                    Phase 3 Active
                  </p>
            ...
            <div className="bg-white border border-border-warm rounded-3xl p-6 flex flex-col justify-between gap-6 group hover:border-primary/30 transition-all warm-shadow">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                  <h3 className="text-sm font-serif font-bold text-text-primary">Content Pieces</h3>
                  <p className="text-[10px] text-sage font-extrabold uppercase tracking-wider flex items-center gap-1">
                    <Check className="w-3.5 h-3.5 text-sage" />
                    Phase 4 Active
                  </p>
